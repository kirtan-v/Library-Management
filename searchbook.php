...
<?php
    ...
    echo'<div><form name="sorting" action="http://localhost/Library/sortbooks.php" method="POST">
            <label style="font-family:serif">Sort By:
                <select name="sort">
    ...
    echo'<form name="searching" action="http://localhost/Library/searchbook.php" method="POST">
            <label style="font-family:serif">Search:<input type="text" name="search" maxlength="30" placeholder="book name, publisher, ISBN"/></label> 
    ...
    $query= "select* from books WHERE name LIKE '%$search_val%' OR publisher LIKE '%$search_val%' OR isbn='$search_val'";
